...
export const AppConfig = {
    ...
    texts: {
        ...
        terminalNoise: [
            ...
            "[CHAT] Сканирование чата на запретки... Угроза миновала",
            "[MEME] Рассказывай рассказывай, я пока рекламу посмотрю...",
            "[MEME] Внимание! О, с нами альцгеймер играет.",
            "[LETHAL] Квота: НЕ ВЫПОЛНЕНА. Активируем протокол увольнения",
            "[MINECRAFT] Алмазы обнаружены на высоте -59. Активация жадности",
            "[CS2] Зафиксирован промах в упор. Пакеты не виноваты",
            "[REPO] Лут собран. Жизнь продана за копейки",
            "[BIOSHOCK] Букер, лови! *Бросает монетку в лицо*",
            "[TOMODACHI] Жители острова снова просят еду. Выдана туалетная бумага",
            "[ROULETTE] Дилер зарядил дробовик. Шансы на выживание: 50/50",
            "[MOUTHWASHING] Зафиксирована утечка рассудка экипажа...",
            "[TETLA] Перезагрузка модуля сарказма... Успешно",
